...
<p>
  <img src="assets/research-agent-evidence.png" alt="ResearchAgent evidence selection" width="49%" />
  <img src="assets/research-agent-dossier.png" alt="ResearchAgent cited dossier" width="49%" />
</p>
...
- [`DESIGN.md`](docs/contracts/DESIGN.md)
- [`PRODUCT.md`](docs/contracts/PRODUCT.md)
- [`SECURITY.md`](docs/contracts/SECURITY.md)
- [`UX-CONTRACT.md`](docs/contracts/UX-CONTRACT.md)
