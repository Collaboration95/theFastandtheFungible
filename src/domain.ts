...
export type Run = {
  ...
  config: ResearchConfig; runtime: RuntimeStatus; quoteGeneration?: number; plan?: ResearchPlanArtifact; purchaseKeys?: Record<string, string>; purchasePlan?: { sourceId: string; reason: string; gap: string; provider: 'groq' | 'fixture'; model: string; status: 'LIVE' | 'FALLBACK' };
}
